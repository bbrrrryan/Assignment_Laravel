...
@section('title', 'Edit Notification - TARUMT FMS')
...
<div class="container">
    <div class="page-header">
        ...
        <div>
            <a href="{{ route('admin.notifications.show', $notification->id) }}" class="btn-secondary">
        ...
        <div class="form-card">
            <form action="{{ route('admin.notifications.update', $notification->id) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <textarea id="message" name="message" rows="4" required>{{ old('message', $notification->message) }}</textarea>
                </div>

        ...
        <div class="details-card">
            <div class="details-section">
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value">
                        <span class="badge badge-priority-{{ $notification->priority }}">{{ ucfirst($notification->priority) }}</span>
                    </span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Status:</span>
                    <span class="detail-value">
                        <span class="badge badge-{{ $notification->is_active ? 'success' : 'secondary' }}">
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value">{{ $notification->creator->name ?? 'System' }}</span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Created At:</span>
                    <span class="detail-value">{{ $notification->created_at->format('Y-m-d H:i:s') }}</span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Updated At:</span>
                    <span class="detail-value">{{ $notification->updated_at->format('Y-m-d H:i:s') }}</span>
                </div>
            </div>
            ...
            <div class="details-section">
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value">{{ $notification->scheduled_at->format('Y-m-d H:i:s') }}</span>
                </div>
                @if($notification->expires_at)
                <div class="detail-row">
                    <span class="detail-label">Expires At:</span>
                    <span class="detail-value">{{ $notification->expires_at->format('Y-m-d H:i:s') }}</span>
                </div>
                @endif
            </div>
            @endif
